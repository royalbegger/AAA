...
roslaunch esdf_pkg ESDF.launch
conda deactivate
python3 VFHtest.py 
cd ..
source devel/setup.bash
...
conda deactivate
source devel/setup.bash
roslaunch astar_planner astar_planner.launch 
conda deactivate
source devel/setup.bash
roslaunch jackal_helper gazebotest.launch world_idx:=282
rosrun esdf_voronoi voronoi_skeleton
